...
del_frame.place(x=100, y=150, width=400, height=180)  # Adjusted y coordinate
...
client_login = Button(del_frame, text="Client Login", bg="white", fg="black", font=15, command=callClient)
client_login.grid(row=20, column=0, pady=10, padx=10)

admin_login = Button(del_frame, text="Admin Login", bg="white", fg="black", font=15, command=callUser)
