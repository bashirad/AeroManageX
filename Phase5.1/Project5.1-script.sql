...
VALUES
  (1, 'Destination Airport 1', '2023-11-01 10:00:00', 'Gate 1', 'Terminal A'),
  (2, 'Destination Airport 2', '2023-11-01 11:30:00', 'Gate 2', 'Terminal B'),
  (3, 'Destination Airport 3', '2023-11-01 12:45:00', 'Gate 3', 'Terminal C')
...
VALUES
  (1, 'Origin Airport 1', '2023-11-01 07:00:00', 'Gate 4', 'Terminal X'),
  (2, 'Origin Airport 2', '2023-11-01 08:30:00', 'Gate 5', 'Terminal Y'),
  (3, 'Origin Airport 3', '2023-11-01 09:15:00', 'Gate 6', 'Terminal Z')
  -- Add more data as needed
  ;

-- Insert data into mydb.Flight_Attendent
INSERT INTO mydb.Flight_Attendent (Flight_Att_ID, Flight_Att_FName, Flight_Att_LName, Hire_Date, Flight_Attendent_DOB)
VALUES
  (1, 'John', 'Doe', '2023-01-15 08:00:00', '1990-03-12'),
  (2, 'Jane', 'Smith', '2022-05-20 10:30:00', '1988-07-28'),
  (3, 'Michael', 'Johnson', '2021-11-10 14:15:00', '1995-09-05')
  -- Add more data as needed
  ;
...
VALUES
  (1, '2023-11-01 08:30:00', '2023-11-01 10:30:00', 2.0, 1, 'ABC123', 1, 2, 101, 201, 1),
  (2, '2023-11-01 09:15:00', '2023-11-01 11:15:00', 2.0, 2, 'XYZ789', 2, 3, 102, 202, 2),
  (3, '2023-11-01 10:00:00', '2023-11-01 12:00:00', 2.0, 3, 'DEF456', 3, 1, 103, 203, 3)
  -- Add more data as needed
  ;

-- Insert data into mydb.Flight_Attendent_has_Flight
INSERT INTO mydb.Flight_Attendent_has_Flight (connection_id, Flight_Att_ID, Flight_ID, Org_Airport_ID, Des_Airport_ID, Pilot_ID, Plane_ID)
VALUES
  (1, 1, 1, 1, 2, 201, 101),
  (2, 2, 2, 2, 3, 202, 102),
  (3, 3, 3, 3, 1, 203, 103)
